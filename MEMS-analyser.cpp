...
int main(int argc, char *argv[]) {
	...
	condCoords = new condensator[CAPs_count];
	vectorArray = new vector[vectorCount];
	if (CAPs_count < 20) crossingsCount = CAPs_count*vectorCount;
